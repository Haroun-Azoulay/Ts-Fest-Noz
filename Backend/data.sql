...
(gen_random_uuid(), 'artist2', 'artist2', '$2b$10$P363xqmpALT17xJ9t9WZ1eKDylCHZ07178mzqfCYxq0imlgvakFKa', 'artist2@gmail.com', 'artist', 'artist2', NOW(), NOW()),
(gen_random_uuid(), 'user', 'user', '$2b$10$sO8lStcEkLjQeBogv/m/DOjIhLLwBuRm7S7a4I9vpzcSOgYZcBPzS', 'user@gmail.com', 'user', 'user', NOW(), NOW()),
(gen_random_uuid(), 'user2', 'user2', '$2b$10$sO8lStcEkLjQeBogv/m/DOjIhLLwBuRm7S7a4I9vpzcSOgYZcBPzS', 'user2@gmail.com', 'user', 'user2', NOW(), NOW()),
