announcementspage.vue : <template>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <ul class="list-boxed-s1">
                                    <li
                                        v-bind:style="isArtist || isOrganizer ? 'pointer-events:auto;cursor:pointer;' : 'pointer-events: none;' "
            ...
            <div class="row g-custom-x align-items-center">
                <div class="col-lg-12">
                    <div class="text-center">
                        ...
                        <h2 class="wow fadeInUp" data-wow-delay=".2s"><span class="id-color">01</span> Annonces des organisateurs près de vous</h2>
                        <div class="small-border bg-color-2"></div>
                        <div class="spacer-single"></div>
                    </div>
                </div>
            </div>
            <div id="list-announcement-posts" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div v-for="organizerAnnouncement in organizerAnnouncements" :key="organizerAnnouncement.id" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
        ...
        <div class="container" v-if="isOrganizer">
            <div class="row g-custom-x align-items-center">
                <div class="col-lg-12">
                    <div class="text-center">
                        <div class="wm wow slideInUp">Annonces</div>
                        <h2 class="wow fadeInUp" data-wow-delay=".2s"><span class="id-color">01</span> Annonces des artistes près de vous</h2>
                        <div class="small-border bg-color-2"></div>
                        <div class="spacer-single"></div>
                    </div>
                </div>
            ...
            <div id="list-announcement-posts" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div v-for="artistAnnouncement in artistAnnouncements" :key="artistAnnouncement.id" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            ...
            <div class="d-flex justify-content-center align-items-center" style="flex-direction:column;margin-bottom:5%;">
                <h2 class="mb-6 mt-6" style="font-size:22px;font-weight:600;">
                    Vous souhaitez laisser une annonce ?
                </h2>
                <button @click="goToAddPostPage()"
            ...
            <div id="list-announcement-posts" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div v-for="artist in closeArtists" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <h2 class="text-xl font-semibold mb-2 text-black">{{ artist.firstname }} {{ artist.lastname }}</h2>
        ...
        try {
            ...
            if (authToken) {
                ...
                if (roleId) {
                    ...
                    if (roleId === "artist") {
                        const getOrganizerAnnouncements = await ApiService.get(`/post/get-close-organizer-posts`, {
                            headers: {
                        ...
                        const getArtistAnnouncements = await ApiService.get(`/post/get-close-artist-posts`, {
                            headers: {
                                Authorization: `Bearer ${authToken}`,
                            },
                        });
                        ...
                        const getCloseArtists = await ApiService.get(`/users/get-close-artists`, {
                            headers: {
                                Authorization: `Bearer ${authToken}`,
                            },
                        });
