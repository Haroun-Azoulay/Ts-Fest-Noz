<template>
    <div>
      ...
      <section class="flex flex-col md:flex-row justify-center items-center p-4 md:p-16 max-w-screen-lg mx-auto">
        <div class="text-center md:text-left md:mr-8 flex-1 mb-8 md:mb-0">
          ...
          <div class="flex flex-col md:flex-row justify-center md:justify-start">
            <button
              class="ButtonPrimary md:w-80 h-12 px-6 m-2 py-2.5 bg-violet-600 rounded-lg flex justify-center items-center"
              @click="goToCityPage">
      ...
      <section class="max-w-screen-lg mx-auto p-4 md:p-16 flex flex-col md:flex-row items-center space-y-8 md:space-y-0 md:space-x-12">
        <div class="text-center md:text-left flex-1">
          ...
          <button
            class="ButtonPrimary md:w-80 h-12 px-6 py-2.5 bg-violet-600 rounded-lg flex justify-center items-center mb-6"
            @click="goForumPage">
            <span class="ButtonSecondary text-center text-white text-base font-bold font-['Inter']">
              Accéder au forum
            </span>
  ...
  .ButtonPrimary {
    @apply md:w-80 h-12 px-6 m-2 py-2.5 bg-violet-600 rounded-lg flex justify-center items-center;
  }
